...
noise_gyr = mvnrnd(0,0.001,D_N);
noise_gps = mvnrnd(0,0.2,D_N);
noise_acc = mvnrnd(0,0.001,D_N);
% noise_gyr = mvnrnd(0,0.00001,D_N);
% noise_gps = mvnrnd(0,0.2,D_N);
% noise_acc = mvnrnd(0,0.01,D_N);
% noise_w = mvnrnd(0,0.01,D_N);
% noise_gyr = noise_w;
% noise_gps = noise_w;
% noise_acc = noise_w;
% noise_gyr = 0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% roll = 0;
roll2 = atan2(Delta_sita(3,2),Delta_sita(1,2))/pi*180+180;
roll = 74;
...
for i = 1:BAS.n
    ...
    BAS.fleft=f3(BAS.xleft,N,vb,Beta);
    BAS.xright=BAS.x-BAS.dir*BAS.d0;
    BAS.fright=f3(BAS.xright,N,vb,Beta);    
