...
BAS.k = 2;                  %space dimension
BAS.x = [mod(0,360);mod(0,360)];        %intial value
BAS.xbest = BAS.x;
BAS.f = f2(BAS.x,N,vb,Beta);
BAS.fbest = BAS.f;
...
for i = 1:BAS.n
    ...
    BAS.fleft=f2(BAS.xleft,N,vb,Beta);
    BAS.xright=BAS.x-BAS.dir*BAS.d0;
    BAS.fright=f2(BAS.xright,N,vb,Beta);    
